 ...
 * Command line was: qdbusxml2cpp -p udisks xml/org.freedesktop.UDisks.xml
 *
...
#ifndef UDISKS_H_1382267058
#define UDISKS_H_1382267058
...
public:
    ...
    Q_PROPERTY(QVariant KnownFilesystems READ knownFilesystems)
    inline QVariant knownFilesystems() const
    { return qvariant_cast< QVariant >(property("KnownFilesystems")); }
